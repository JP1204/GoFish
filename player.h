...
public:
    ...
    void addCard(Card const &c);  //adds a card to the hand
    void bookCards(Card const &c1, Card const &c2);
    ...
    //The Player must have the card in hand for this function to be called
